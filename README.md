...
- For Ubuntu/Debian some packages are needed.  `sudo apt install git build-essential libc6-dev libssl-dev ruby-dev ruby-bundler ruby-bcrypt ruby-ffi ruby-oj locales`
Also, if your system doesn't have it by default  `sudo locale-gen en_US.UTF-8`
